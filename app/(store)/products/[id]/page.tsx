                    ...
                    >
                      {img ? (
                        <img
                          src={img}
                          alt={product.name}
                          className="w-full h-[250px] md:h-full md:aspect-square object-contain p-4 md:p-6 transition-transform duration-500 md:group-hover:scale-150 origin-center"
                        />
                      ) : (
                        <div className="w-full h-[250px] md:aspect-square flex items-center justify-center text-8xl bg-gray-50">📦</div>
                      )}
                      {/* Zoom hint desktop */}
